...
class NonEpisodicTieredImagenet(Dataset):
    ...
    def __init__(self, path, split, transforms=t.ToTensor(), **kwargs):
        ...
        self.ROOT_PATH = path
        #if os.path.isdir('/network/home/ostapeno/data'):
        #    self.ROOT_PATH = '/network/home/ostapeno/data'
        #else:
        #self.ROOT_PATH = '/network/home/ostapeno/data'
        #self.ROOT_PATH = '/Users/oleksostapenko/Projects/data/tiered-imagenet/tiered-imagenet' #'/mnt/datasets/public/research/tiered-imagenet' '/network/home/ostapeno/data' #
        #self.ROOT_PATH = '/network/home/ostapeno/data'
